...
function App() {
  ...
  return (
    <BrowserRouter>
      <div className="container-fluid " id='fibox' style={{ display: "flex" }}>
        <div style={{ display: "flex" }}>
          ...
          <div id='sidebar'><div className="d-flex flex-nowrap" >
            <div className="d-flex flex-column flex-shrink-0 p-3 bg-light" style={{ width: "280px", height: "100vh", display: "none" }} id='sidebar' >
        ...
        <div id='sebox'>
          <div id="collapsebg" class="alert alert-primary my-2" role="alert">
            <div><button id='collapse' className='btn btn-link' onClick={() => {
